...
c.MarkdownExporter.template_path = ['/Users/kylehausmann/github/khgitting.github.io']
c.MarkdownExporter.template_file = 'jekyll_notebook'
...
if f:
    ...
    c.FilesWriter.build_directory = '/Users/kylehausmann/github/khgitting.github.io/_posts'
